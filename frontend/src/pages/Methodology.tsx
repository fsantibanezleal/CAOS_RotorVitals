...
export default function Methodology() {
  ...
  const mlTab = (
    <div className="prose">
      ...
      <Equation tex={String.raw`\mathbf{v} = \big[\,\kappa,\ \gamma,\ \mathrm{crest},\ \mathrm{impulse},\ \mathrm{shape},\ \mathrm{clearance},\ P(\mathrm{BPFO}),\ P(\mathrm{BPFI}),\ P(2{\cdot}\mathrm{BSF}),\ \kappa_{\text{res}}\,\big]\in\mathbb{R}^{10} \;\xrightarrow{\text{StandardScaler}}\; \{\text{SVM-RBF},\ \text{RandomForest}\}`} caption={es ? 'el vector de 10 features (κ: curtosis, γ: asimetría, κ_res: curtosis de la banda de resonancia); el StandardScaler va horneado dentro del ONNX' : 'the 10-feature vector (κ: kurtosis, γ: skewness, κ_res: resonance-band kurtosis); the StandardScaler is baked into the ONNX'} />
      <p>{es
