  ...
  tabs: [
    {
      ...
      body_en:
        ...
        '"what fault is this, and how long until it fails?". Choosing a bearing, a planted fault and a severity (on real ' +
        'CWRU data) recomputes the kurtogram, envelope spectrum, cyclostationary map and RUL live.\n\n' +
      ...
      body_es:
        ...
        'respondiendo "¿qué fallo es este, y cuánto falta para que falle?". Al elegir un rodamiento, un fallo plantado y una ' +
        'severidad (sobre datos reales de CWRU), el kurtograma, el espectro de envolvente, el mapa cicloestacionario y la ' +
        'RUL recalculan en vivo.\n\n' +
        'Es un sistema real, no una demo. El motor de diagnóstico recalcula en el navegador con cada ' +
    ...
    },
    {
      ...
      body_en:
        ...
        'Offline / compute (the local machine, an isolated Python environment): the Python pipeline bakes the canonical case artifacts (the ' +
      ...
      body_es:
        ...
        'TypeScript se re-ejecuta con cada control y onnxruntime-web ejecuta el WDCNN + el autoencoder como modelos ONNX, sin ' +
        'servidor. Offline / cómputo (la máquina local, un entorno Python aislado): el pipeline Python precalcula los artefactos canónicos por ' +
    ...
    },
    {
      ...
      body_en:
        'The App page recomputes live: inputs (the case selector or a supplied recording, plus the bearing, fault, ' +
      ...
      body_es:
        'La página App recalcula en vivo: las entradas (el selector de casos o una grabación propia, más los controles de ' +
    ...
    },
    {
      ...
      body_es:
        ...
        '(SES); ③ los picos del SES se asocian a las frecuencias físicas de defecto BPFO/BPFI/2·BSF (BPFO = ' +
        ...
        'primera capa ancha) y un autoencoder profundo (features → índice de salud); ambos se ejecutan en el cliente como ' +
    ...
    },
    {
      ...
      body_en:
        ...
        'accepts supplied data, not just the built-in CWRU cases. Contract 2 (artifact) defines the output the web reads ' +
      ...
      body_es:
        ...
        'guardas de rango/NaN, para que la app acepte datos propios, no solo los casos CWRU incluidos. El Contrato 2 ' +
        ...
        'ambos, el pipeline por etapas y determinista ejecuta el lane gate (numpy-light por defecto, el paso de reentrenamiento ' +
